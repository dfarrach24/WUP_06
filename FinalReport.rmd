...
Based on this data set there is still a significant difference in attitude toward capital punishment (cappun) based on race. As whites still reflect a high percentage in favoring capital punishment and blacks still reflect about 50/50 favoring and opposing. 
...
Based on the numerical results whites favor capital punishment by approximately by 68%, blacks by 47% and other races by 61%.  Among those who oppose only 32% are white, 39% are other race and blacks oppose by approximately 53%. 
...
The P-value is 0.0001 and reject the null hypothesis meaning there is a significant difference in attitude towards capital punishment based on race.




Based on the fisher Test the p value is 0.00001741 meaning there is a significant difference in attitude towards capital punishment between black and whites.  

# Discussion and Conclusion

<!--Discussion and conclusion here.  If you found a relationship be sure to consider whether the relationship occurs because one of the variavbles causes the other, or whether they perhasps are related for some other reason.  Watch the chapter 6 videos from the GeorgeTown videos collection.!-->

In the small data sets there is a significant difference in attitude toward capitol punishment (cappun)  based on race between black and white. The only difference is between black and white and no other race. 