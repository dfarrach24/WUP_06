...
Based on this smaller data set there is no data of a statistical difference in attitude towards capital punishment. The p-value = 1.741e-05, hence we reject the null hypothesis.  
...
The different data sets reflect that there is a significant difference in attitude toward capitol punishment (cappun)  based on face. In this data set 2659 were observed. This data set reflects there is a higher percentage of white you favor cappun vs blacks. With a smaller data set Black both favor and oopse capital punishment equally. 